...
gc = GraphCreator("config/input/items.txt",
                  "config/input/recipes.json",
                  "config/input/tags.json",
                  "config/equivalencyTags.json",
                  "config/CustomRecipe.json",
                  "config/bannedKeywords.json",
                  "config/mainItemReference.csv")
